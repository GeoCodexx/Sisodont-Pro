...
export default function OdontogramCanvas({
  ...
  const { width: SVG_WIDTH, height: SVG_HEIGHT } =
    getSVGDimensions(odontogramType);
    ...
    ? [
        {
          ...
          x: 22,
          y: 10,
          anchor: "start" /*text: "18─11", x: 22, y: 13, anchor: "start"*/,
        },
        {
          text: "21─28",
          x: SVG_WIDTH - 22,
          y: 10,
          anchor:
            "end" /*text: "21─28", x: SVG_WIDTH - 22, y: 13, anchor: "end"*/,
        },
        { text: "48─41", x: 22, y: SVG_HEIGHT, anchor: "start" },
        { text: "31─38", x: SVG_WIDTH - 22, y: SVG_HEIGHT, anchor: "end" },
      ]
    : [
        {
          text: "55─51",
          x: 30,
          y: 10,
          anchor: "start" /*text: "55─51", x: 22, y: 13, anchor: "start"*/,
        },
        { text: "61─65", x: SVG_WIDTH - 10, y: 13, anchor: "end" },
        { text: "85─81", x: 22, y: SVG_HEIGHT, anchor: "start" },
        { text: "71─75", x: SVG_WIDTH - 10, y: SVG_HEIGHT, anchor: "end" },
      ];
